                              ...
                              Column(
                                children: <Widget>[
                                  ...
                                  TextFormField(
                                    ...
                                    validator: (val) => val.isEmpty
                                        ? 'Enter status when you took your blood glucose level'
                                        : null,
                                    onChanged: (val) {
                                      ...
                                      await showDatePicker(
                                        ...
                                        if (value != null &&
                                          ...
                                          setState(() {
                                            ...
                                            isDateSelected = true;
                                            glucose_date =
                                                "${glucoseDate.month}/${glucoseDate.day}/${glucoseDate.year}";
                                          });
                                      ...
                                      FlatButton(
                                        ...
                                        onPressed: () async {
                                          ...
                                          try {
                                            ...
                                            final readGlucose = databaseReference
                                                .child('users/' +
                                                    uid +
                                                    '/vitals/health_records/blood_glucose_list');
                                            readGlucose.once().then(
                                              ...
                                              if (datasnapshot.value == null) {
                                                final glucoseRef = databaseReference
                                                    .child('users/' +
                                                        uid +
                                                        '/vitals/health_records/blood_glucose_list/' +
                                                        1.toString());
                                                glucoseRef.set({
                                                  ...
                                                  "lastMeal":
                                                      lastMeal.toString(),
                                                  "glucose_status":
                                                      glucose_status.toString(),
                                                  "bloodGlucose_date":
                                                      glucose_date.toString(),
                                                  "bloodGlucose_time":
                                                      glucose_time.toString(),
                                                  "new_glucose": true
                                                });
                                                print(
                                                    "Added Blood Glucose Successfully! " +
                                                        uid);
                                              } else {
                                                Future.delayed(
                                                    const Duration(
                                            ...
                                            if (glucose < 80) {
                                              addtoRecommendation(
                                                  "Your blood sugar is lower than normal. You should speak to your physician about it and seek immediate medical attention if you feel unwell. In the meantime, have something to eat to help improve your condition.",
                                            ...
                                            if (glucose > 120 &&
                                                double.parse(
                                                    ...
                                                    2) {
                                              addtoRecommendation(
                                                  "Your blood sugar is higher than normal and we have already informed your doctor and support system about it. "
                                                  ...
                                                  if (uid != a.doctor1) {
                                                    await addtoNotif2(
                                                            "Your <type> " +
                                                                thisuser
                                                                    .firstname +
                                                                " has recorded high blood glucose. This may require your immediate medical attention.",
                                                            thisuser.firstname +
                                                                " has  high Blood Glucose readings",
                                                            "3",
                                                            a.doctor1)
                                                        .then((value) {
                                                      notifsList.clear();
                                            ...
                                            Future.delayed(
                                              ...
                                              glucose_list.add(
                                                  new Blood_Glucose(
                                                      ...
                                                      bloodGlucose_status:
                                                          glucose_status,
                                                      bloodGlucose_date: format
                                                          .parse(glucose_date),
                                                      bloodGlucose_time:
                                                          timeformat.parse(
                                                              glucose_time)));
                                              for (var i = 0;
                                                  i < glucose_list.length / 2;
                                                  i++) {
                                                var temp = glucose_list[i];
                                                glucose_list[i] = glucose_list[
                                                    glucose_list.length -
                                                        1 -
                                                        i];
                                                glucose_list[
                                      ...
                                      onPressed: () {
                                        ...
                                        final glucoseRef =
                                            databaseReference.child('users/' +
                                                ...
                                                count.toString());
                                        glucoseRef.set({
                                          "glucose": gluc.toString(),
                                          "lastMeal": lastM.toString(),
                                          "glucose_status": "normal",
                                          "bloodGlucose_date": now.month
                                                  .toString()
                                                  .padLeft(2, '0') +
                                              "/" +
                                              now.day
