...
class blood_glucose_doctor_view extends StatefulWidget {
  ...
  blood_glucose_doctor_view({Key key, this.bglist, this.userUID})
      : super(key: key);
  @override
...
class _blood_glucoseDoctorState extends State<blood_glucose_doctor_view> {
  ...
  void getBloodGlucose() {
    ...
    final readBC = databaseReference.child(
        'users/' + userUID + '/vitals/health_records/blood_glucose_list/');
