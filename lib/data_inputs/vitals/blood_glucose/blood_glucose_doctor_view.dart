            ...
            TextButton(
              ...
              onPressed: () {
                ...
                for(int i = 1; i <= initialLength; i++){
                  final bpRef = databaseReference.child('users/' + userUID + '/vitals/health_records/blood_glucose_list/' + i.toString());
                  bpRef.remove();
                }
                for(int i = 0; i < bgtemp.length; i++){
                  final bpRef = databaseReference.child('users/' + userUID + '/vitals/health_records/blood_glucose_list/' + (i+1).toString());
                  bpRef.set({
