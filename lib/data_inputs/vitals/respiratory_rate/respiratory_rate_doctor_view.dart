...
class _respiratory_rate_doctor_viewState extends State<respiratory_rate_view_as_doctor> {
          ...
          actions: <Widget>[
            TextButton(
              ...
              onPressed: () {
                ...
                // final uid = user.uid;
                String userUID = widget.userUID;
                int initialLength = respiratory_list.length;
                List<int> deleteList = [];
                ...
                for(int i = 0; i < deleteList.length; i++){
                  respiratory_list.removeAt(deleteList[i]);
                }
                for(int i = 1; i <= initialLength; i++){
                  final bpRef = databaseReference.child('users/' + userUID + '/vitals/health_records/respiratoryRate_list/' + i.toString());
                  bpRef.remove();
                }
                for(int i = 0; i < respiratory_list.length; i++){
                  final bpRef = databaseReference.child('users/' + userUID + '/vitals/health_records/respiratoryRate_list/' + (i+1).toString());
                  bpRef.set({
