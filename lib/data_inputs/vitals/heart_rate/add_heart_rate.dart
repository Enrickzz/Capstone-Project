...
class add_heart_rate extends StatefulWidget {
  ...
  String userUID; //if logged in is SS
  add_heart_rate({this.thislist, this.instance, this.userUID});
  @override
...
class _add_heart_rateState extends State<add_heart_rate> {
            ...
            child: Column(
                ...
                children: <Widget>[
                  ...
                  TextFormField(
                    ...
                    validator: (val) =>
                        val.isEmpty ? 'Enter Number of Beats' : null,
                    onChanged: (val) {
                      ...
                      await showDatePicker(
                        ...
                        if (value != null && value != heartRateDate) {
                          setState(() {
                            ...
                            isDateSelected = true;
                            heartRate_date =
                                "${heartRateDate.month}/${heartRateDate.day}/${heartRateDate.year}";
                          });
                      ...
                      FlatButton(
                        ...
                        onPressed: () async {
                          try {
                            ...
                            readHeartRate
                              ...
                              if (datasnapshot.value == null) {
                                ...
                                heartRateRef.set({
                                  ...
                                  "hr_status": hr_status,
                                  "hr_date": heartRate_date.toString(),
                                    ...
                                    readConnections
                                      ...
                                      temp.forEach((jsonString) {
                                        ...
                                        addtoNotif(
                                            "Your <type> " +
                                                thisuser.firstname +
                                                " has recorded a very low heart rate and requires your immediate medical attention",
                                            thisuser.firstname +
                                                " has very low heart rate!",
                                            "3",
                                            a.doctor1,
                                            "None");
                                      });
                            ...
                            if (widget.instance == "Reminder!") {
                              if (beats > 100 && hr_status == "Resting") {
                                ...
                                readConnections
                                  ...
                                  temp.forEach((jsonString) {
                                    connections
                                        .add(Connection.fromJson(jsonString));
                                    Connection a =
                                        Connection.fromJson(jsonString);
                                    print(a.doctor1);
                                    addtoNotif(
                                        "Your <type> " +
                                            thisuser.firstname +
                                            " has recorded a high heart rate and requires your immediate medical attention",
                                        thisuser.firstname +
                                            " has consecutive high heart rate readings",
                                        "3",
                                        a.doctor1,
                                        "None");
                                  });
                            ...
                            if (beats < 40) {
                              addtoNotif(
                                  "Your Heart Rate is alarming which is why we have already notified your doctor and support system regarding this. Please remain calm at all times and seek immediate medical attention.",
                                  "High Heart Rate!",
                                  "2",
                                  uid,
                                  "None");
                            ...
                            Future.delayed(const Duration(milliseconds: 1000),
                              ...
                              print("MEDICATION LENGTH: " +
                                  heartRate_list.length.toString());
                              heartRate_list.add(new Heart_Rate(
                                  bpm: beats,
                                  hr_status: hr_status,
                                  hr_date: format.parse(heartRate_date),
                                  hr_time: timeformat.parse(heartRate_time)));
                              for (var i = 0;
                                  i < heartRate_list.length / 2;
                                  i++) {
                                var temp = heartRate_list[i];
                                heartRate_list[i] = heartRate_list[
                                    heartRate_list.length - 1 - i];
                                heartRate_list[heartRate_list.length - 1 - i] =
                                    temp;
                              }
                              print("POP HERE ==========");
  ...
  void getHeartRate(String uid) {
    heartRate_list.clear();
    // final User user = auth.currentUser;
    // final uid = user.uid;
    final readHR = databaseReference
        .child('users/' + uid + '/vitals/health_records/heartrate_list/');
