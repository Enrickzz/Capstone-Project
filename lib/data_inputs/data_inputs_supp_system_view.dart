...
class data_inputs_ss_view extends StatefulWidget {
  final String userUID;
  data_inputs_ss_view({Key key, this.userUID}) : super(key: key);
  @override
  _AppSignUpState createState() => _AppSignUpState();
}

class _AppSignUpState extends State<data_inputs_ss_view> {
                ...
                children: <Widget>[
                  ...
                  GestureDetector(
                    onTap:(){
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => supplement_prescription(preslist: supplementList, userUID: widget.userUID)),
                      );
                    },
                    child: Container(
                        margin: EdgeInsets.fromLTRB(10, 0, 10, 15),
                  ...
                  GestureDetector(
                    onTap:(){
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => medication(medlist: thismedlist, userUID: widget.userUID)),
                      );
                    },
                    child: Container(
                        margin: EdgeInsets.fromLTRB(10, 0, 10, 15),
                  ...
                  GestureDetector(
                    onTap:(){
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => symptoms(symptomlist1: thislist, userUID: widget.userUID)),
                      );
                    },
                    child: Container(
                        margin: EdgeInsets.fromLTRB(10, 0, 10, 15),
                  ...
                  GestureDetector(
                    onTap:(){
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => lab_results(userUID: widget.userUID)),
                      );
                    },
                    child: Container(
                        margin: EdgeInsets.fromLTRB(10, 0, 10, 15),
