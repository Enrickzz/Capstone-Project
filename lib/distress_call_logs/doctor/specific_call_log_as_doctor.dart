...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: SpecificCallLogAsDoctor(title: 'Flutter Demo Home Page'),
    );
  }
}

class SpecificCallLogAsDoctor extends StatefulWidget {
  SpecificCallLogAsDoctor({Key key, this.title, this.index, this.thislist,this.userUID}) : super(key: key);
  final String title;
  final List<distressSOS> thislist;
  int index;
  String userUID;
  @override
  _SpecificCallLogAsDoctorState createState() => _SpecificCallLogAsDoctorState();
}

class _SpecificCallLogAsDoctorState extends State<SpecificCallLogAsDoctor> with SingleTickerProviderStateMixin {
