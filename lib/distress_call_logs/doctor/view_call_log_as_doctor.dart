...
import 'package:my_app/distress_call_logs/doctor/specific_call_log_as_doctor.dart';
...
class call_log_doctorView extends StatefulWidget {
  final List<Medication_Prescription> preslist;
  final int pointer;
  final String userUID;
  call_log_doctorView({Key key, this.preslist, this.pointer, this.userUID}): super(key: key);
  @override
  call_logDoctorViewState createState() => call_logDoctorViewState();
}

class call_logDoctorViewState extends State<call_log_doctorView> {
              ...
              child: Card(
                child: ListTile(
                    ...
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => SpecificCallLogAsDoctor(thislist: SOS, index: index,userUID: widget.userUID,)),
                      );
                    }
