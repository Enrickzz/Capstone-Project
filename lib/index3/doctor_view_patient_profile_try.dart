...
class view_patient_profileTry extends StatefulWidget {
  const view_patient_profileTry({Key key, this.animationController}) : super(key: key);
...
class _index3State extends State<view_patient_profileTry>
    ...
    return Container(
        ...
        child: Scaffold(
          appBar: AppBar(
            ...
            title: const Text("Display Name's Profile Try", style: TextStyle(
                color: Colors.black
            )),
            centerTitle: true,
