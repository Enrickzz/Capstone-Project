...
class specific_journal_patient_view extends StatefulWidget {
  String userUID;
  int index;
  specific_journal_patient_view({Key key, this.userUID, this.index}): super(key: key);
  @override
...
class _specific_postState extends State<specific_journal_patient_view>
  ...
  void getReplies() {
    ...
    final readReplies = databaseReference.child('users/' + uid + '/journal/'+ (widget.index).toString() +'/replies/');
