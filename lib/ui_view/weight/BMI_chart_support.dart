...
class BMI_Chart_support extends StatefulWidget {
  final AnimationController animationController;
  final Animation<double> animation;
  const BMI_Chart_support({Key key, this.animationController, this.animation})
      : super(key: key);

  @override
  State<BMI_Chart_support> createState() => _BMI_Chart_supportState();
}

class _BMI_Chart_supportState extends State<BMI_Chart_support> {
