...
class weight_trend_support extends StatefulWidget {
  final AnimationController animationController;
  final Animation<double> animation;
  final String userUID;
  const weight_trend_support({Key key, this.animationController, this.animation, this.userUID})
      : super(key: key);

  @override
  State<weight_trend_support> createState() => _weight_trend_supportState();
}

class _weight_trend_supportState extends State<weight_trend_support> {
