...
class water_intake_chart_doctor extends StatefulWidget {
  ...
  @override
  State<water_intake_chart_doctor> createState() => _water_intake_chart_doctorState();
...
class _water_intake_chart_doctorState extends State<water_intake_chart_doctor> {
  ...
  Widget build(BuildContext context) {
    ...
    thisseries = water_intake_chart_doctor._createSampleData(sunday, monday, tuesday, wednesday, thursday, friday,saturday, goal);
