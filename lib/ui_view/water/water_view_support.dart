...
class WaterViewSupport extends StatefulWidget {
  const WaterViewSupport(
  ...
  @override
  _WaterViewSupportState createState() => _WaterViewSupportState();
}

class _WaterViewSupportState extends State<WaterViewSupport> with TickerProviderStateMixin {
