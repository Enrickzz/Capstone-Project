...
class view_exrx_support extends StatefulWidget {
  final ExercisesTest exercise;
  view_exrx_support({this.exercise});
  @override
  _view_exrx_supportState createState() => _view_exrx_supportState();
}
final _formKey = GlobalKey<FormState>();

class _view_exrx_supportState extends State<view_exrx_support> {
