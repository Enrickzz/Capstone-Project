...
import 'package:my_app/goal_tab/exercises/view_exrx_support.dart';
...
class ExerciseScreenSupport extends StatefulWidget {
  const ExerciseScreenSupport({Key key, this.animationController, this.search, this.userUID}) : super(key: key);
  final AnimationController animationController;
  final String search;
  final String userUID;
  @override
  Exercise_screen_support_state createState() => Exercise_screen_support_state();
}
...
class Exercise_screen_support_state extends State<ExerciseScreenSupport>
                                                ...
                                                onPressed: () {
                                                  showModalBottomSheet(context: context,
                                                    ...
                                                    builder: (context) => SingleChildScrollView(child: Container(
                                                      ...
                                                      child: view_exrx_support(exercise: listexercises[index]),
                                                    ),
                                                    ),
                                                  );
                                                },
