...
import 'package:my_app/goal_tab/meals/detailsPage_support.dart';
...
class nutritionix_meals_support extends StatefulWidget {
  ...
  @override
  _nutritionix_meals_supportState createState() => _nutritionix_meals_supportState();
}

final _formKey = GlobalKey<FormState>();


class _nutritionix_meals_supportState extends State<nutritionix_meals_support>
              ...
              child: InkWell(
                onTap: (){
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => DetailsPage_support(heroTag:(""+result[index].photo.thumb).toString(),
