...
class add_food_intake_support extends StatefulWidget {
  final heroTag;
  final foodName;
  final weight;
  final calories;
  ...
  @override
  _addFoodIntakeSupportState createState() => _addFoodIntakeSupportState();
}
final _formKey = GlobalKey<FormState>();
class _addFoodIntakeSupportState extends State<add_food_intake_support> {
