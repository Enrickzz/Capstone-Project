...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: SpecificFoodPrescriptionViewAsSupport(title: 'Flutter Demo Home Page'),
    );
  }
}
class CardItem{
...
class SpecificFoodPrescriptionViewAsSupport extends StatefulWidget {
  SpecificFoodPrescriptionViewAsSupport({Key key, this.title, this.index, this.thislist, this.animationController}) : super(key: key);
...
class _SpecificFoodPrescriptionViewAsDoctorState extends State<SpecificFoodPrescriptionViewAsSupport> with SingleTickerProviderStateMixin {
