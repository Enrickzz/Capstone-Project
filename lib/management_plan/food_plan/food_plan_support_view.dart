...
import 'package:my_app/management_plan/food_plan/specific_food_plan_supp_view.dart';
...
class food_prescription_support_view extends StatefulWidget {
...
class _food_prescriptionState extends State<food_prescription_support_view> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: const Text('Patient Food Planner', style: TextStyle(
              color: Colors.black
          )),
          centerTitle: true,
              ...
              child: Card(
                child: ListTile(
                    ...
                    onTap: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => SpecificFoodPrescriptionViewAsSupport(thislist: foodPtemp,index: index, animationController: widget.animationController)),
                      );
                    }
