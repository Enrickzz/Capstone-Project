...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: SpecificVitalsPrescriptionViewAsSupport(title: 'Flutter Demo Home Page'),
    );
  }
}

class SpecificVitalsPrescriptionViewAsSupport extends StatefulWidget {
  SpecificVitalsPrescriptionViewAsSupport({Key key, this.title, this.index, this.thislist}) : super(key: key);
...
class _SpecificVitalsPrescriptionViewAsPatientState extends State<SpecificVitalsPrescriptionViewAsSupport> with SingleTickerProviderStateMixin {
