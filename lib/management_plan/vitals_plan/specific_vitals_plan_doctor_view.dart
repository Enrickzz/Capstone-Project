...
class SpecificVitalsPrescriptionViewAsDoctor extends StatefulWidget {
  SpecificVitalsPrescriptionViewAsDoctor({Key key, this.title, this.userUID, this.index}) : super(key: key);
  final String title;
  String userUID;
  int index;
  @override
            ...
            TextButton(
              ...
              onPressed: () {
                ...
                for(int i = 1; i <= initial_length; i++){
                  final bpRef = databaseReference.child('users/' + uid + '/management_plan/vitals_plan/' + i.toString());
                  bpRef.remove();
                }
                /// write fields
                for(int i = 0; i < templist.length; i++){
                  final bpRef = databaseReference.child('users/' + uid + '/management_plan/vitals_plan/' + (i+1).toString());
                  bpRef.set({
