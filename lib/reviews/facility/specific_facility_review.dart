...
import 'package:my_app/reviews/facility/add_facility_review.dart';
import 'package:my_app/reviews/facility/info_facility.dart';
...
class facility_reviews extends StatefulWidget {
  @override
...
class _discussionState extends State<facility_reviews>
    ...
    return Container(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: const Text('Facility Reviews', style: TextStyle(
              color: Colors.black
          )),
          centerTitle: true,
