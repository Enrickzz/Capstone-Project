...
class info_recreational extends StatefulWidget {
  ...
  info_recreational({Key key, this.files, this.this_info, this.thisrating,this.type});
...
class _create_postState extends State<info_recreational> {
                      ...
                      Visibility(
                        ...
                        child: FlatButton(
                          ...
                          onPressed:() {
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => recreational_reviews(thisPlace: widget.this_info, type: widget.type)),
                            );
                          },
                        ),
                      ),
