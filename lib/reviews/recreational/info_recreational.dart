...
import 'package:my_app/reviews/recreational/specific_recreational_reviews.dart';
...
class info_recreational extends StatefulWidget {
  final List<FirebaseFile> files;
  info_recreational({Key key, this.files});
  @override
  _create_recreationalState createState() => _create_recreationalState();
}
final _formKey = GlobalKey<FormState>();
class _create_recreationalState extends State<info_recreational> {
                      ...
                      Visibility(
                        ...
                        child: FlatButton(
                          ...
                          onPressed:() {
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => recreational_reviews()),
                            );
                          },
                        ),
                      ),
