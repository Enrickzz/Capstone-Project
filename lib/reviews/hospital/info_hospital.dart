...
import 'package:my_app/reviews/hospital/specific_hospital_reviews.dart';
...
class info_hospital extends StatefulWidget {
  ...
  info_hospital({Key key, this.files, this.this_info, this.thisrating,this.type});
...
class _create_postState extends State<info_hospital> {
                      ...
                      Visibility(
                        ...
                        child: FlatButton(
                          ...
                          onPressed:() {
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => hospital_reviews(thisPlace: widget.this_info, type: widget.type)),
                            );
                          },
                        ),
                      ),
