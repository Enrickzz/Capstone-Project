...
class add_hospital_review extends StatefulWidget {
  final List<FirebaseFile> files;
  final Results thisPlace;
  final String type;
  add_hospital_review({Key key, this.files, this.thisPlace, this.type});
  @override
  _create_postState createState() => _create_postState();
}
final _formKey = GlobalKey<FormState>();
class _create_postState extends State<add_hospital_review> {
