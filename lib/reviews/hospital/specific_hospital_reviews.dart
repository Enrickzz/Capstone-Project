...
import 'package:my_app/reviews/hospital/add_hospital_review.dart';
...
class hospital_reviews extends StatefulWidget {
  final Results thisPlace;
  final String type;
  hospital_reviews({Key key,this.thisPlace, this.type});
  @override
...
class _discussionState extends State<hospital_reviews>
                    ...
                    onTap: () {
                      showModalBottomSheet(context: context,
                        ...
                        builder: (context) => SingleChildScrollView(child: Container(
                          ...
                          child: add_hospital_review(thisPlace: widget.thisPlace,type: widget.type ),
                        ),
                        ),
                      ).then((value) {
