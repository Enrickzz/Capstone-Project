...
class TabIconData {
  ...
  static List<TabIconData> tabIconsList = <TabIconData>[
    ...
    TabIconData(
      imagePath: 'assets/fitness_app/meals_exercises.png',
      selectedImagePath: 'assets/fitness_app/meals_exercises2.png',
      index: 4,
      isSelected: true,
      animationController: null,
    ),
    TabIconData(
      imagePath: 'assets/fitness_app/location.png',
      selectedImagePath: 'assets/fitness_app/location2.png',
      index: 5,
      isSelected: true,
      animationController: null,
    ),
    TabIconData(
      imagePath: 'assets/fitness_app/goals.png',
      selectedImagePath: 'assets/fitness_app/goals2.png',
      index: 6,
      isSelected: true,
      animationController: null,
    ),
